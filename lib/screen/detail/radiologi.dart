      ...
      builder: (context, snapshot) {
        if (!snapshot.hasData) {
          ...
          return Scaffold(
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          pasien['hasil'] != null ? pasien['hasil']['hasil'] : "Belum ada hasil analisa",
                          style: TextStyle(
                            fontSize: 14,
                            color: pasien['hasil'] != null ? Colors.black : Colors.grey.shade500,
                          ),
                        ),
                      ],
                    )
                      ...
                      children: [
                        ...
                        GridView.builder(
                          ...
                          gridDelegate: SliverGridDelegateWithMaxCrossAxisExtent(
                            ...
                            crossAxisSpacing: 5, // Spasi horizontal antara elemen dalam grid
                          ),
            ...
            // floatingActionButton: widget.pasien['hasil'] == null
            //   ? FloatingActionButton(
            //       onPressed: () => Msg.info(context, "Masih dalam pengembangan"),
            //       backgroundColor: Helper.penjabColor(widget.penjab),
