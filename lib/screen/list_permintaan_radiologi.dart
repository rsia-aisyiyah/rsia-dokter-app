...
class ListPermintaanRadiologi extends StatefulWidget {
  const ListPermintaanRadiologi({super.key});

  @override
  State<ListPermintaanRadiologi> createState() => _ListPermintaanRadiologiState();
}

class _ListPermintaanRadiologiState extends State<ListPermintaanRadiologi> {
  ...
  Future fetchPasien() async {
   var res = await Api().getData("/pasien/radiologi/permintaan");
            ...
            itemBuilder: (context, index) {
              if (dataPasien.isEmpty) {
                return const BoxMessage(
                  ...
                  body: "Belum ada permintaan pasien radiologi",
                );
              }
